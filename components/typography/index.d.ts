...
export type Variant = 'large-title-l' | 'large-title-m' | 'large-title-s' | 'title-l-1' | 'title-m-1' | 'title-s-1' | 'title-l-2' | 'title-m-2' | 'title-s-2' | 'title-l-3' | 'title-m-3' | 'title-s-3' | 'headline-l' | 'headline-m' | 'headline-s' | 'callout-l' | 'callout-m' | 'callout-s' | 'body-l' | 'body-m' | 'body-s' | 'subheadline-l' | 'subheadline-m' | 'subheadline-s' | 'footnote-l' | 'footnote-m' | 'footnote-s' | 'caption-l-1' | 'caption-m-1' | 'caption-s-1' | 'caption-l-2' | 'caption-m-2' | 'caption-s-2' | 'inherit';
export type Props = {
    as?: AsElement;
